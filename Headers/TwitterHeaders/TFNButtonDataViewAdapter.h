...
{
    BOOL _useSizeThatFits;
}

@property(nonatomic) BOOL useSizeThatFits; // @synthesize useSizeThatFits=_useSizeThatFits;
...
- (struct CGSize)_sizeForButton:(id)arg1 constrainedToSize:(struct CGSize)arg2 withOptions:(id)arg3 defaultPadding:(struct UIEdgeInsets)arg4;
