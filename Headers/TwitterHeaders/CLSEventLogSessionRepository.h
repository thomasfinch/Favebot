...
+ (unsigned int)priorityForEventLogFileWithName:(id)arg1;
+ (id)activeEventLogFileNameForPriority:(unsigned int)arg1;
...
- (id)eventLogFileURLForStateName:(id)arg1 sessionIdentifier:(id)arg2 sessionTimestamp:(unsigned long long)arg3 sessionFragmentIdentifier:(id)arg4 sessionFragmentTimestamp:(unsigned long long)arg5 eventPriority:(unsigned int)arg6 error:(id *)arg7;
