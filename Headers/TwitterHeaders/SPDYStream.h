...
@class NSData, NSInputStream, NSRunLoop, NSString, NSURLRequest, SPDYProtocol;
...
@interface SPDYStream : NSObject <NSStreamDelegate>
{
    ...
    unsigned int _writeDataIndex;
    unsigned int _writeStreamChunkLength;
...
- (void)handleDataStreamEvent:(unsigned long)arg1;
- (void)didLoadData:(id)arg1;
- (void)didReceiveResponse:(id)arg1;
- (id)readData:(unsigned int)arg1 error:(id *)arg2;
