...
@class NSArray, NSMutableArray, NSMutableData, NSString, NSTimer, SPDYSocketReadOp, SPDYSocketWriteOp;
...
- (void).cxx_destruct;
- (void)handleCFWriteStreamEvent:(unsigned long)arg1 forStream:(struct __CFWriteStream *)arg2;
- (void)handleCFReadStreamEvent:(unsigned long)arg1 forStream:(struct __CFReadStream *)arg2;
