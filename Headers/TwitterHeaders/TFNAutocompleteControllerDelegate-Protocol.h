...
@class TFNTwitterAutocompleteController;

@protocol TFNAutocompleteControllerDelegate <NSObject>
- (void)autocompleteController:(TFNTwitterAutocompleteController *)arg1 didSelectItem:(id <TFNAutocompleteResultItem>)arg2;
