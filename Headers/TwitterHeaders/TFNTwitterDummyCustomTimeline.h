...
#import "TFNTwitterCustomTimeline.h"

#import "TFNTwitterDummyObject.h"

@class NSString;

@interface TFNTwitterDummyCustomTimeline : TFNTwitterCustomTimeline <TFNTwitterDummyObject>
{
    BOOL _loading;
...
+ (id)dummyCustomTimelineOfType:(int)arg1;
